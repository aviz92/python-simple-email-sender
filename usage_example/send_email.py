...
def main() -> None:
    logger = build_logger(project_name="Gmail Sender", log_level=logging.DEBUG, extra={"user": "test_user"})
    ...
    sender.send_email(to_email=_to_email, subject=_subject, message=_message, attachment_file=_attachment_file)
